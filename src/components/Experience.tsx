...
export default function Experience() {
  return (
    <section id="experience" className="px-12 py-16 border-b border-border">
      ...
      <h2 className="font-serif text-[32px] text-foreground mb-10">Where I&apos;ve Worked</h2>
        ...
        {roles.map((role, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              {index < roles.length - 1 && <div className="w-px flex-1 bg-border mt-1.5" />}
            </div>
            ...
            <div className={index < roles.length - 1 ? 'pb-9' : ''}>
              ...
              <div className="font-mono text-[11px] text-accent my-[3px]">{role.role}</div>
